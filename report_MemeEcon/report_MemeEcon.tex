...
\section{Template Section} \label{sec:Template}
    ...
    \begin{figure}[t]
        \centering
        \subfigure[Meme Format]{\includegraphics[width=.49\textwidth]{img/yelling_template.jpg}}
        \subfigure[Meme]{\includegraphics[width=.49\textwidth]{img/yelling_4.jpg}}
    ...
    \begin{figure} [t]
        \centering
        \includegraphics[width=.3\textwidth]{img/drake_4.jpg}
